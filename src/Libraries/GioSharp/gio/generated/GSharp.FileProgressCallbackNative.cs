...
#region Autogenerated code
	...
	internal class FileProgressCallbackInvoker {
		...
		internal G.FileProgressCallback Handler {
			get {
				return new G.FileProgressCallback(InvokeNative);
			}
		}
	...
	internal class FileProgressCallbackWrapper {
		...
		G.FileProgressCallback managed;

		public FileProgressCallbackWrapper (G.FileProgressCallback managed)
		{
		...
		public static G.FileProgressCallback GetManagedDelegate (FileProgressCallbackNative native)
		{
			if (native == null)
				return null;
