...
#region Autogenerated code
	...
	internal class AsyncReadyCallbackInvoker {
		...
		internal G.AsyncReadyCallback Handler {
			get {
				return new G.AsyncReadyCallback(InvokeNative);
			}
		}

		void InvokeNative (GLib.Object source_object, G.AsyncResult res)
		{
	...
	internal class AsyncReadyCallbackWrapper {
		...
		{
			try {
				managed (GLib.Object.GetObject (source_object), G.AsyncResultAdapter.GetObject (res, false));
				if (release_on_call)
					gch.Free ();
			} catch (Exception e) {
		...
		G.AsyncReadyCallback managed;

		public AsyncReadyCallbackWrapper (G.AsyncReadyCallback managed)
		{
		...
		public static G.AsyncReadyCallback GetManagedDelegate (AsyncReadyCallbackNative native)
		{
			if (native == null)
				return null;
