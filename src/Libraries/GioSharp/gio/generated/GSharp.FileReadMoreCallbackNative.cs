...
#region Autogenerated code
	...
	internal class FileReadMoreCallbackInvoker {
		...
		internal G.FileReadMoreCallback Handler {
			get {
				return new G.FileReadMoreCallback(InvokeNative);
			}
		}
	...
	internal class FileReadMoreCallbackWrapper {
		...
		G.FileReadMoreCallback managed;

		public FileReadMoreCallbackWrapper (G.FileReadMoreCallback managed)
		{
		...
		public static G.FileReadMoreCallback GetManagedDelegate (FileReadMoreCallbackNative native)
		{
			if (native == null)
				return null;
