...
#region Autogenerated code
	...
	internal class SimpleAsyncThreadFuncInvoker {
		...
		internal G.SimpleAsyncThreadFunc Handler {
			get {
				return new G.SimpleAsyncThreadFunc(InvokeNative);
			}
		}

		void InvokeNative (G.SimpleAsyncResult res, GLib.Object objekt, G.Cancellable cancellable)
		{
	...
	internal class SimpleAsyncThreadFuncWrapper {
		...
		{
			try {
				managed (GLib.Object.GetObject(res) as G.SimpleAsyncResult, GLib.Object.GetObject (objekt), GLib.Object.GetObject(cancellable) as G.Cancellable);
				if (release_on_call)
					gch.Free ();
			} catch (Exception e) {
		...
		G.SimpleAsyncThreadFunc managed;

		public SimpleAsyncThreadFuncWrapper (G.SimpleAsyncThreadFunc managed)
		{
		...
		public static G.SimpleAsyncThreadFunc GetManagedDelegate (SimpleAsyncThreadFuncNative native)
		{
			if (native == null)
				return null;
