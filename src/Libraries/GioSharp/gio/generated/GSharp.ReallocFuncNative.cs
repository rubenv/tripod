...
#region Autogenerated code
	...
	internal class ReallocFuncInvoker {
		...
		internal G.ReallocFunc Handler {
			get {
				return new G.ReallocFunc(InvokeNative);
			}
		}
	...
	internal class ReallocFuncWrapper {
		...
		G.ReallocFunc managed;

		public ReallocFuncWrapper (G.ReallocFunc managed)
		{
		...
		public static G.ReallocFunc GetManagedDelegate (ReallocFuncNative native)
		{
			if (native == null)
				return null;
